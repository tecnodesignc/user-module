                        ...
                        <div class="box-body">
                            <el-tabs>
                                ...
                                <el-tab-pane :label="trans('roles.tabs.permissions')">
                                    <encore-permissions v-model="role.permissions"
                                                        is-role
                                                        :current-permissions="role.permissions"></encore-permissions>
                                </el-tab-pane>
...
<script>
    ...
    import EncorePermissions from './EncorePermissions.vue';

    export default {
        mixins: [Slugify, ShortcutHelper],
        components: {
            'encore-permissions': EncorePermissions,
        },
        props: {
